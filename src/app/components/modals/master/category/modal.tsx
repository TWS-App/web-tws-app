...
import { Button, Divider, Form, Input, InputNumber, Modal, Row, Typography } from "antd";
...
export default function ModalCategoryProduct({
  ...
  const handleSubmit = async (value: any) => {
    if (isEdit) {
      try {
        const result = await categoryProductServices.update(value, value?.id);
