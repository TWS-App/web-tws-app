  ...
  return (
    <div className="w-full">
      <Link
        ...
        className="block self-center-safe text-center group"
      >
        <div
          key={item?.id}
          className=""
          // className="aspect-square relative overflow-hidden h-[350px]"
        >
          {item?.images && item?.images?.length > 0 ? (
            // <Carousel arrows dots dotPosition="bottom" effect="fade" autoplay>
