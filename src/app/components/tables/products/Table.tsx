...
// Antd Components
import { Input, Modal, Spin, Tag, Tooltip } from "antd";
                ...
                {data.map((items: any) => (
                  ...
                  >
                    <td className="py-3 px-4">
                      <div>
                        <p className="font-semibold">{items.product_name}</p>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex flex-wrap gap-1">
                        {items.colors?.map((color: string) => (
                          <Tag key={color} color={getColorByName(color)}>
                            {color}
                          </Tag>
                        ))}
                      </div>
                      {/* <span
                        className={`px-2 py-1 rounded text-xs ${
                          statusColors[items?.category as CategoryType]
                        }`}
                      >
                        {items.status}
                      </span> */}
