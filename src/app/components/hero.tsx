...
const HeroBanner = () => {
  return (
    <section className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white py-20 px-6">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/explore"
              className="border border-indigo-500 text-indigo-500 px-6 py-2 rounded hover:bg-indigo-50 transition"
            >
              Explore Top NFTs
            </Link>
            <Link
