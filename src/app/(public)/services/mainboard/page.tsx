...
// Types
import { mediasocials } from "../types/socials";

// CODE
export default function ServiceMainboardPage() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="w-full flex cursor-pointer">
          <img
            ...
            alt={"baterai"}
            key={"baterai"}
            className="justify-center items-center align-middle shadow-md hover:shadow-xl hover:scale-105 rounded-xl p-4 border transition-transform"
          />
        </div>

        <hr className="border-t border-black mt-5 mb-5" />
        ...
        >
          <Image
            src={"/images/assets/CALLWHATSAPP.png"}
            alt={"WACALL"}
            className="cursor-pointer object-cover hover:scale-105 transition-transform duration-500 bg-white"
            // height={300}
            fallback="data:image/png;base64,"
            preview={false}
          />
