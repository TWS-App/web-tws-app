...
export default function ServiceTWS() {
  ...
  return (
    <section className="w-full bg-white ">
      <div className="max-w-7xl mx-auto mt-3 px-6 text-center border-t-4 border-t-black">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-600 mt-10 mb-12">
          SERVICE TWS
        </h2>

        <div className="bg-white shadow-xl/30 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 cursor-pointer">
          {services.map((srv) => (
            <div
              key={srv.id}
